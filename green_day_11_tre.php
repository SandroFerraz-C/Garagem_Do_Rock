...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>
                - ¡Tré! é o décimo primeiro álbum de estúdio lançado pela banda - Green Day e o terceiro da trilogia ¡Uno!, ¡Dos! e ¡Tré!.
            </p>

            <p>
                O álbum segue o estilo power pop de ¡Uno!, e o estilo garage rock de ¡Dos!. O título do álbum é uma referência ao baterista Tré Cool.
            </p>


            <p>
                O álbum estreou em #13° lugar na Billboard 200, com vendas na primeira semana de 58 mil cópias nos Estados Unidos.
            </p>
            ...
            <p>Duração do álbum: 46 min. 35 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    <iframe src="https://open.spotify.com/embed/playlist/5hOkIWHX9eddxTIWlUgpZY" width="100%" height="700" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                </table>
            </section>
            ...
            <nav>
                <h3>Crédito:</h3>
                <ul>
                    <li><a href="#" onMouseOver="mostraLayer('divBJ11');" onMouseOut="escondeLayer('divBJ11');">Billie Joe Armstrong</a> – Vocal e Guitarra. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divMD11');" onMouseOut="escondeLayer('divMD11');">Mike Dirnt</a> – Baixo e Vocal de apoio. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divTC11');" onMouseOut="escondeLayer('divTC11');">Tré Cool</a> – Bateria, Percussão e Vocal de apoio. </li>
                </ul>
            </nav>
            ...
            <div id="divMD11" name="nm_divMD11">
                <p>
            ...
            <div id="divTC11" name="nm_divTC11">
                <p>
