...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>Esse álbum contém a música "Ride On", que foi uma escolha deles para homenagear Bon Scott, e duas músicas do álbum - <a href="acdc_11_fly_on_the_wall.php" target="blank">Fly On The Wall</a> de 1985 "Sink The Pink" e "Shake Your Foundations".</p>
            ...
            <p>Esse álbum possui também dois clipes, são eles das faixas "Who Made Who" música principal do álbum e um clipe especial para a faixa super clássica "You Shook Me All Night Long", sendo essa música umas das mais importantes na carreira do AC/DC e umas das
                ...
                mais famosas do álbum "<a href="acdc_08_black_in_black.php" target="blank">Back In Black</a>".</p>
            <br />
            ...
            <section>
                ...
                <div id="divSIMON_WRIGHT" name="nm_divSIMON_WRIGHT">
                    <p>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="#" onMouseOver="mostraLayer('divSIMON_WRIGHT');" onMouseOut="escondeLayer('divSIMON_WRIGHT');">Simon Wright</a> – Bateria.</li>
                    <li><a href="#" onMouseOver="mostraLayer('divBON_SCOTT');" onMouseOut="escondeLayer('divBON_SCOTT');">Bon Scott</a> – Vocal.</li>
