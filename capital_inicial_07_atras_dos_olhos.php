    ...
    <main>
        <section class="content-section">
            ...
            <p>
                ...
                bastantes execuções em rádios brasileiras e na MTV. A canção "O Mundo" obteve cinco indicações no VMB, o
                maior número de indicações que a banda já obteve em qualquer premiação da MTV. Este é o último álbum de
                estúdio com Loro Jones.
            </p>

            <br />
            <p>Duração do album: 43 min. 37 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <div id="divFL07" name="nm_divFL07">
                        <p>
                    ...
                    <div id="divFEL07" name="nm_divFEL07">
                        <p>
