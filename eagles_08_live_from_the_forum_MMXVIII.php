...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Live from the Forum MMXVIII (2020)</h1>
            <br />

            <p>
                Live from the Forum MMXVIII é um álbum ao vivo e DVD do concerto dos Eagles. Nele esta a gravação de shows no Forum em Inglewood,
                Califórnia, que ocorreram durante três noites em setembro de 2018. É o primeiro lançamento a apresentar os novos membros da banda
                Deacon Frey e Vince Gill ao lado de Don Henley , Joe Walsh e Timothy B. Schmit. Deacon, filho do ex-membro da banda Glenn Frey, e Gill
                se juntaram à banda após o falecimento do mais velho Frey em 2016. Foi lançado em 16 de outubro de 2020, em uma variedade de formatos,
                incluindo CD, DVD e Blu-ray
            </p>
            <br />

            <p>
                A turnê norte-americana incluiu uma parada de três noites (12, 14 e 15 de setembro de 2018) no Forum em Los Angeles, Califórnia,
                onde os shows foram gravados. O setlist incluía muitas das canções mais conhecidas dos Eagles, mas também sucessos gravados por
                membros individuais, como "The Boys of Summer" de Henley, "Life's Been Good" de Walsh e "Don't Let Our" de Gill Love Start Slippin
                ...
                A única música em seu setlist omitida neste lançamento é "Witchy Woman", com "The Long Run" de 14 de setembro adicionada.
            </p>
            <br /><br />

            <p>Duração do album: 2 hs. 17 min. 33 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/0QO8pzjSQeQ4p0rlEw7CJH" width="100%" height="1750" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br />
                    ...
                    <div id="divVG08" name="nm_divVG08">
                        <p>
                            <img class="css" src="img/eagles/vgg.png" width="150px;" height="130px;">
