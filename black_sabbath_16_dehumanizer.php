    ...
    <main>
        <section class="content-section">
            ...
            <p>
                ...
                e o primeiro em nove anos a apresentar o baixista original Geezer Butler. Sessões iniciais de composição e demo no Rich Bitch Studios
                em Birmingham apresentaram o baterista Cozy Powell; Bootlegs dessas sessões existem. No entanto, quando Cozy se machucou com um quadril
                quebrado, ele foi substituído por Vinny. Com Vinny de volta à banda, isso efetivamente reuniu a formação. A banda passou duas
                semanas escrevendo material antes de passar seis semanas ensaiando e gravando demos no Monnow Valley Studios no País de Gales.
            </p>

            <p>
                "Foi bom tentar isso com Ronnie ... "Iommi refletiu em 1997." [Mas] perdemos milhões com isso ... por causa do tempo que
                levamos para gravar e voar para trás e para frente para os Estados Unidos com tudo, todo o equipamento; trazendo de volta;
                gravando aqui [no Reino Unido] ... Muita confusão e muito dinheiro desperdiçado ... Se fosse de novo agora, poderíamos
                planejar de forma diferente e tudo ficaria bem, mas tínhamos que tentar isso. Cosy estava envolvido fisicamente, porém ele
                não estava mentalmente."
            </p>

            <p>
                Tanto liricamente quanto musicalmente é considerado um dos álbuns mais pesados do Black Sabbath. Os temas das letras falam sobre adoração a
                computadores, televangelismo, individualismo e dúvidas sobre a vida após a morte.
            </p>
            <br />

            <p>Duração do album: 55 min. 53 seg.</p>
            <p>Gravadora(s): I.R.S. Records e Reprise Records (EUA/Canadá).</p>
            <p>Produção: Reinhold Mack e Black Sabbath. </p>
            <br /><br />
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <div id="divGB16" name="nm_divGB16">
                        <p>
                    ...
                    <div id="divVA16" name="nm_divVA16">
                        <p>
                            <img class="css" src="img/Black Sabbath/va.jpg" width="150px;" height="130px;">
                            Vincent Samson Appice é um baterista estadunidense do cenário do rock n' roll mundial,
                            principalmente o heavy metal. Ele ficou famoso por tocar em importantes bandas, principalmente no Black Sabbath, na qual entrou em 1980.
                            <br />
                    ...
                    <div id="divGN16" name="nm_divGN16">
                        <p>
