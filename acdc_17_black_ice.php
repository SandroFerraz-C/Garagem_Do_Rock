...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>BLACK ICE (2008)</h1>

            <p>
                - Black Ice é o 15° álbum de estúdio da banda australiana. É seu primeiro álbum em oito anos.
            </p>

            <p>
                Lançado internacionalmente em 20 de outubro de 2008, foi produzido por Brendan O'Brien. Isso marcou as primeiras gravações originais da banda desde - <a href="acdc_16_stiff_upper_lip.html" target="blank">Stiff Upper Lip</a> de 2000, com
                o intervalo de oito anos sendo o mais longo entre os sucessivos álbuns de estúdio do AC/DC. - Black Ice tem o tempo de execução mais longo de qualquer álbum de estúdio da banda.
            </p>

            <p>
                O desenvolvimento do álbum foi atrasado porque o baixista Cliff Williams se machucou e a banda mudou de gravadora, da Elektra Records para a Sony Music Entertainment. As primeiras sessões de composição entre os guitarristas / irmãos Angus e Malcolm Young
            ...
            <p>
                - Black Ice fez história ao estrear em #1° nas paradas de álbuns de 29 países, e é o maior álbum de estreia da Columbia Records desde que Nielsen SoundScan começou a rastrear dados de vendas para a Billboard em março de 1991. - Black Ice foi o segundo
                álbum mais vendido em todo o mundo em 2008, atrás Coldplay's - Viva La Vida or Death and All His Friends. Em dezembro de 2008, ele tinha vendido seis milhões de cópias em todo o mundo, e ganhou certificações de vendas em 24 países, com
                status de multi-platina em oito, platina em mais doze e ouro nos quatro restantes.
            </p>

            <p>
                O cantor Brian Johnson temia que este álbum não fosse lançado haja visto o espaço de tempo de oito anos dentre o - Black Ice e o último trabalho de estúdio. “Na primeira faixa do disco os pêlos dos meus braços arrepiaram. Eu pensei, ‘é uma banda boa ou
                não é?‘”.
            </p>
            <br />
            ...
            <div class="tabela">
                <table border="1px" width="45%">
                    ...
                    <tr>
                        <td width="15%"> 2X Platina + Diamante</td>
                        <td> + 1.000.000 (Alemanha)</td>
                    </tr>
                    <tr>
                        <td width="15%"> Platina + Diamante</td>
                        <td> + 600.000 (França)</td>
                    </tr>
                    <tr>
                        <td width="15%"> 5X Platina</td>
                        <td> + 400.000 (Canadá)</td>
                    </tr>
                    <tr>
                        <td width="15%"> 5X Platina</td>
                    ...
                    <tr>
                        <td width="15%"> 2X Platina</td>
                        <td> + 12.000 (Hungria)</td>
                    </tr>
                    <tr>
                        <td width="15%"> Ouro</td>
                        <td> + 10.000 (Portugal)</td>
                    </tr>
            ...
            <p>Duração do album: 55 min. 39 seg. </p>
