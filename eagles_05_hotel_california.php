...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Hotel California (1976)</h1>

            <p>- Hotel California é o quinto álbum da banda Eagles.</p>

            <p>O álbum foi gravado por Bill Szymczyk nos estúdios Criteria e Record Plant entre março e outubro de 1976, e então lançado no Asylum
                em dezembro. Foi o primeiro álbum com o guitarrista Joe Walsh, que substituiu o membro fundador Bernie Leadon, e é o último álbum com
                o baixista Randy Meisner. A capa é uma fotografia do Beverly Hills Hotel, de David Alexander.</p>

            <p>O álbum Hotel California liderou a parada de LPs e fitas da Billboard nos EUA. No 20º Grammy Awards, os Eagles ganharam um Grammy por
                "Hotel California", e por " New Kid in Town ". O álbum foi indicado para Álbum do Ano, mas perdeu para Fleetwood Mac 's Rumors.
                Três singles foram lançados do álbum, com dois no topo da Billboard Hot 100 , "New Kid in Town" e "Hotel California", enquanto " Life in the Fast Lane " alcançou a 11ª posição.</p>

            <p>Uma edição especial do 40º aniversário do Hotel California foi lançada em novembro de 2017. Hotel California é um dos álbuns mais
                vendidos de todos os tempos. Foi certificado como 26 × Platina nos Estados Unidos e vendeu mais de 32 milhões de cópias em todo o
            ...
            <div class="tabela">
                <table border="1px" width="45%">
                    ...
                    <tr>
                        <td width="15%"> 26X Platina </td>
                        <td> + 26.000.000 (EUA)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> + 400.000 (Espanha)</td>
                    </tr>
                    <tr>
                        <td width="15%"> Platina </td>
                        <td> + 250.000 (Holanda)</td>
                    </tr>
                    <tr>
                        <td width="15%">4X Platina </td>
                        <td> + 120.000 (Noruega)</td>
                    </tr>
                    <tr>
                        <td width="15%"> 2X Platina </td>
                        <td> + 100.000 (Suíça)</td>
            ...
            <section class="disco">
                <table id="demo-table">
                    <iframe src="https://open.spotify.com/embed/playlist/43meRJjlM4uaLYbo7H7Cic" width="100%" height="550" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                </table>
            </section>
