...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Get Your Wings (1974)</h1>


            <p>
                - Get Your Wings, é o segundo álbum de estúdio da banda de rock estadunidense Aerosmith, lançado em 1 de março, 1974.
                O álbum é o primeiro a ter a participação na produção de Jack Douglas, que passaria a produzir os próximos quatro álbuns da banda.
            </p>

            <p>
                Em sua autobiografia, Tyler escreve que "Seasons of Wither" estava "germinando na minha cabeça há muito tempo, mas as outras faixas
                mais sinistras, como "Lord of the Thighs", vieram da área decadente onde gravamos o álbum. "Lord of the Thighs" era sobre um cafetão
                e a vida selvagem nas ruas". Tyler toca piano em "Lord of the Thighs", cuja batida de abertura é semelhante à que Kramer faria um ano
                depois em "Walk This Way". Ele afirmou que o título era um trocadilho com o famoso romance de William Golding, - O Senhor das Moscas -,
                e "os críticos nos odiavam por isso. Não devíamos ser inteligentes o suficiente para usar referências literárias".
            </p>

            <p>
                O título do álbum foi a primeira aparição do logo alado da banda, que passaria a ser modificada e usada em muitos de seus álbuns posteriores.
                O disco também é considerado uma espécie de "laboratório" para seu sucessor, "Toys In The Attic", lançado no ano seguinte.
            </p>
            <br />
            ...
            <div class="tabela">
                <table border="1px" width="45%">
                    ...
                    <tr>
                        <td width="15%">Ouro </td>
                        <td>18 de Abril de 1975</td>
                    </tr>
                    <tr>
                        <td width="15%">Ouro </td>
                        <td> 1 de Novembro de 1976</td>
                    </tr>
                    <tr>
                        <td width="15%">Platina </td>
                        <td> 1 de Maio de 1979</td>
                    </tr>
                    <tr>
                        <td width="15%">Platina </td>
                        <td> 21 de Novembro de 1986</td>
                    </tr>
                    <tr>
            ...
            <p>Duração do album: 38 min. 04 seg.</p>
            <p>Gravadora(s): Columbia Records.</p>
            <p>Produção: Ray Colcord e Jack Douglas </p>
            <br /><br />
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/7sa3hWY1n1VtCiVZi9hpJo" width="100%" height="500" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe> <br /><br />

                    <h3>Créditos</h3>

                    <li><a href="#" onMouseOver="mostraLayer('divST2');" onMouseOut="escondeLayer('divST2');">Steven Tyler</a> – Vocais, Gaita, Teclado e Percussão.</li>
                    <li><a href="#" onMouseOver="mostraLayer('divJP2');" onMouseOut="escondeLayer('divJP2');">Joe Perry</a> – Guitarra Solo, Vocais e Background Vocals.</li>
                    <li><a href="#" onMouseOver="mostraLayer('divBW2');" onMouseOut="escondeLayer('divBW2');">Brad Whitford</a> – Guitara Base.</li>
                    <li><a href="#" onMouseOver="mostraLayer('divTH2');" onMouseOut="escondeLayer('divTH2');">Tom Hamilton</a> – Baixo </li>
                    <li><a href="#" onMouseOver="mostraLayer('divJK2');" onMouseOut="escondeLayer('divJK2');">Joey Kramer</a> – Bateria e Percussão.</li>

                    </ul>
                    <br>


                    <div id="divST2" name="nm_divST2">
                        <p>
