    ...
    <main>
        <section class="content-section">
            ...
            <nav>
                <h3>Créditos</h3>
                <ul>
                    <li><a href="#" onMouseOver="mostraLayer('divSTEVEN_TYLER');" onMouseOut="escondeLayer('divSTEVEN_TYLER');">Steven Tyler</a> – Vocal.</li>
                    ...
                    <li><a href="#" onMouseOver="mostraLayer('divBRAD_WHITFORD');" onMouseOut="escondeLayer('divBRAD_WHITFORD');">Brad Whitford</a> – Guitarra-base.</li>
                </ul>
            </nav>
