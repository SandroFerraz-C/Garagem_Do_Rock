...
<body>
    <main>
        <section class="content-section">
            ...
            <p>
                - Saturno é o décimo-quarto álbum do Capital Inicial.
            </p>

            <p>
                Foi produzido por David Corcos, que trabalhou com a banda no álbum anterior. O single do trabalho é "O Lado Escuro da Lua“, uma
                referência ao álbum do grupo britânico <a href="pink_floyd.php" target="blank">Pink Floyd</a> - The Dark Side of the Moon, sendo
                também uma das três baladas do disco. O show de lançamento foi na Fundição Progresso em 24 de novembro de 2012 no Rio de Janeiro.
            </p>
            <br />

            <p>Duração do álbum: 44 min. 54 seg.</p>
            ...
            <section>
                ...
                <div id="divYVES_PASSARELL" name="nm_divYVES_PASSARELL">
                    <p>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="#" onMouseOver="mostraLayer('divYVES_PASSARELL');" onMouseOut="escondeLayer('divYVES_PASSARELL');">Yves Passarell</a> – Guitarra.</li>
