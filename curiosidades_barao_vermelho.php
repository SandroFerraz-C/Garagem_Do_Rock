        ...
        <section class="corpo_curiosidade_acdc">
            ...
            <div class="botao_acdc">
                ...
                <div id="demo1" class="collapse">
                    <br />
                    <p>- O nome do Barão Vermelho foi tirado das tirinhas do Snoopy e do Charlie Brown.</p>
                </div>
                <br /><br />
                ...
                <div id="demo2" class="collapse">
                    <br />
                    <p> - Em janeiro de 1985, O Barão Vermelho participou do festival Rock In Rio.</p>
                </div>
                <br /><br />
                ...
                <div id="demo4" class="collapse">
                    <br />
                    <p> - A revista Time já classificou o Barão como a melhor banda da América Latina.</p>
                </div>
                <br /> <br />
                ...
                <div id="demo5" class="collapse">
                    <br />
                    <p> - A música "Homem não Chora" expõe a sensibilidade masculina. Quando fez a música, Frejat tinha o intuito de colocar em
                        questão o fato das pessoas serem tão duras e da criação machista de que homem não pode chorar.</p>
                </div>
                <br /><br />
                ...
                <div id="demo6" class="collapse">
                    <br />
                    <p> - O Cazuza só entrou para o Barão porque o Leo Jaime, candidato a vocalista da banda, tinha a voz suave demais para
                        cantar o rock que o Barão queria, então ele (Leo Jaime) indicou Cazuza para ser o vocalista do grupo.</p>
                </div>
                <br /><br />
                ...
                <div id="demo7" class="collapse">
                    <br />
                    <p> - O Barão teve uma participação no cinema em 1984 com o filme Bete Balanço, onde Cazuza (ainda vocalista na época) compôs a
                        música tema do filme, ambos fazendo o papel de si mesmos, e Cazuza interpretando Tininho, um compositor.</p>
                </div>
                <br /><br />
                ...
                <div id="demo8" class="collapse">
                    <br />
                    <p> - Cazuza ganhou o apelido pelo qual ficou conhecido ainda na barriga da mãe. O seu pai começou a chamá-lo de Cazuza – sinônimo
                        de moleque no Nordeste.</p>
                </div>
                <br /> <br />
                ...
                <div id="demo9" class="collapse">
                    <br />
                    <p> - Quando tinham 11 anos, Cazuza deveria entrevistar alguém importante para um trabalho da escola. O pai de Cazuza ( Que era produtor musical da Som Livre)
                        conseguiu que o poeta e compositor Vinicius de Moraes recebesse ele. Vinicius concedeu a entrevista em sua banheira e deu uísque para Cazuza.
                        O poeta teria se impressionado com o conhecimento de dele.</p>
                </div>
                <br /><br />
                ...
                <div id="demo10" class="collapse">
                    <br />
                    <p> - Aos 15 anos, Cazuza seguia o poeta Carlos Drummond de Andrade quando saía para passear no Leblon e em Ipanema, no Rio.
                        Em entrevista ao jornal O Estado de S. Paulo, sua mãe lembrou que costumava alertá-lo:</p>

                    <p> – Meu filho, ele vai achar que você quer assaltá-lo. E ele respondia que o poeta nem reparava e que ele fazia isso; E fazia
                        porque o admirava muito.</p>
                </div>
                <br /><br />
                ...
                <div id="demo13" class="collapse">
                    <br />
                    <p> - "Todo Amor que Houver Nessa Vida" cairia nas graças de Caetano Veloso, que incluiria a música em suas apresentação.</p>
                </div>
                <br /><br />
                ...
                <div id="demo15" class="collapse">
                    <br />
                    <p> - O bem-sucedido Maior Abandonado, terceiro álbum do grupo, seria lançado em 1984. Foi o último disco do Barão com Cazuza como vocalista.</p>
                </div>
                <br /><br />
                ...
                <div id="demo17" class="collapse">
                    <br />
                    <p>- Cazuza realizava shows intensos, imprevisíveis, às vezes sob muito efeito de álcool e drogas.</p>
                </div>
                <br /><br />
                ...
                <div id="demo19" class="collapse">
                    <br />
                    <p> - Foi por volta de 1985 que Cazuza passaria a ter febre quase diariamente, indícios do vírus HIV que se agravaria mais tarde.</p>
                </div>
                <br /><br />
