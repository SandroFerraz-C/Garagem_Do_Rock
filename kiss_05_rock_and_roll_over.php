...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Rock and Roll Over (1976)</h1>

            <p>
                - Rock and Roll Over é o quinto álbum do Kiss, lançado em Novembro de 1976;
                <br />
                O álbum alcançou a #11ª posição na Billboard 200.
            </p>

            <p>
                Para obter o som de bateria adequado, Peter Criss gravou suas faixas em um banheiro, comunicando-se por vídeo-link com o resto da
                banda.
            </p>
            ...
            <section class="disco">
                <table id="demo-table">
                    <iframe src="https://open.spotify.com/embed/playlist/0jtah1J0fSaFwzbu8BSRNz" width="100%" height="600" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                </table>
            </section>
