...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Rock in a Hard Place (1982)</h1>

            <p>
                - Rock in a Hard Place é o sétimo álbum do Aerosmith, lançado em Agosto de 1982.
            </p>

            <p>
                É o único álbum do Aerosmith a não apresentar o guitarrista Joe Perry, após sua saída da banda em 1979. O guitarrista rítmico Brad
                Whitford também saiu durante a gravação em 1981. A banda gastou $ 1,5 milhão de Dollares na gravação deste álbum, que gravaram
                com o produtor Jack Douglas.
            </p>

            <p>
                Anteriormente, o Aerosmith lançou seis álbuns de estúdio na década de 1970. Mas, com o fim da década, surgiram vários problemas.
                ...
                gravação do álbum foi finalmente concluída.
            </p>

            <p>
                "O disco não é uma merda", escreveu o baterista Joey Kramer em sua autobiografia de 2009, - Hit Hard: Uma história de atingir o fundo do poço no topo -.
            ...
            <p>Duração do album: 38 min. 57 seg.</p>
