...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Come Taste the Band (1975)</h1>
            <br />

            <p>
                Come Taste the Band é o décimo álbum do Deep Purple, originalmente lançado em outubro de 1975.
            </p>
            <br />

            <p>
                O álbum foi co-produzido e concebido pela banda e antigo associado Martin Birch. É o único registro de estúdio com Tommy Bolin,
                que substituiu Ritchie Blackmore na guitarra. Musicalmente, o álbum é mais comercial que os lançamentos anteriores, tendendo a um
                rígido foco de hard rock com toques de soul e funk.
            </p>
            <br />

            <p>
                Sobre o título do álbum, Glenn Hughes, no documentário Phoenix Rising, conta que Tommy Bolin, após uma noite em que ambos beberam
                bastante, proferiu a seguinte frase: "Come taste the wine, come hear the band" ("Venha provar o vinho, venha ouvir a banda").
                Hughes então teria feito a junção das duas frases, originando daí o nome do álbum.
            </p>
            <br />

            <p>
                O álbum vendeu razoavelmente bem após o lançamento (# 19 nas paradas do Reino Unido, e # 43 nos Estados Unidos). O álbum foi
                certificado de prata em 1 de novembro de 1975 pelo BPI, vendendo 60.000 cópias no Reino Unido.
            </p>
            <br />

            <p>
                Nos últimos anos, o álbum recebeu algumas reavaliações críticas "por seus próprios méritos", em parte devido às contribuições de
                Bolin para o álbum. Gillan (que deixou a banda há pouco mais de dois anos), por outro lado, afirmou que não vê o álbum como um
                ...
                pessoas, não é um álbum do Deep Purple. " .
            </p>

            <br /><br />

            <p>Duração do album: 37 min. 61 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/7n60ZO7F2WKvTJbZuMxt5n" width="98%" height="540" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br />
                    ...
                    <div id="divTB10" name="nm_divTB10">
                        <p>
                            <img class="css" src="img/deep purple/tb.jpg" width="150px;" height="130px;">
