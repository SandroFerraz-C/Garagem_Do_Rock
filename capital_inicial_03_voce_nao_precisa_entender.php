        ...
        <section class="content-section">
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <div id="divDOP03" name="nm_divDOP03">
                        <p>
                    ...
                    <div id="divLJ03" name="nm_divLJ03">
                        <p>
                    ...
                    <div id="divFL03" name="nm_divFL03">
                        <p>
                    ...
                    <div id="divFEL03" name="nm_divFEL03">
                        <p>
                    ...
                    <div id="divBB03" name="nm_divBB03">
                        <p>
