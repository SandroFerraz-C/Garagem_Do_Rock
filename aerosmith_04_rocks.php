    ...
    <main>
        <section class="content-section">
            ...
            <p>
                ...
                <a href="metallica.php" target="blank">Metallica</a> e
                <a href="nirvana.php" target="blank">Nirvana</a>. O álbum foi um sucesso comercial, alcançando três singles na Billboard Hot 100,
            ...
            <div class="tabela">
                <table border="1px" width="45%">
                    ...
                    <tr>
                        ...
                        <td> 9 de Julho de 1976</td>
                    </tr>
                    <tr>
                        <td width="15%">2X Platina </td>
                        <td> 19 de Outubro de 1984</td>
                    </tr>
                    <tr>
                        <td width="15%">3X Platina </td>
                        <td> 21 de Dezembro de 1988</td>
                    </tr>
                    <tr>
                        <td width="15%">4X Platina </td>
                        <td> 26 de Novembro de 2001</td>
                    </tr>
