...
<body>
    ...
    <div id="Principal">
        ...
        <main>
            ...
            <nav>
                <a class="loja" href="historia_barao_vermelho.php">Historia da Banda</a>
                <a class="vote" href="curiosidades_barao_vermelho.php">Curiosidades do Barão Vermelho</a>
            </nav>
            ...
            <section class="content-section">
                ...
                <div class="albuns_acdc">
                    ...
                    <a href="barao_vermelho_01_barao_vermelho.php"> <img class="hv" src="img/barao vermelho/01_barao vermelho.jpg" height="310px;" width="360px;" alt=""> </a>

                    <a href="barao_vermelho_02_barao_vermelho_2.php"> <img class="hv" src="img/barao vermelho/02_barao vermelho 2.jpg" height="310px;" width="360px;" alt=""> </a>

                    <a href="barao_vermelho_03_maior_abandonado.php"><img class="hv" src="img/barao vermelho/03_maior abandonado.jpg" height="310px;" width="360px;" alt=""></a>

                    <a href="barao_vermelho_04_declare_guerra.php"><img class="hv" src="img/barao vermelho/04_declare guerra.jpg" height="310px;" width="360px;" alt=""></a>
