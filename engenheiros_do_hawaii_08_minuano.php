...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>
                Minuano é o oitavo álbum dos Engenheiros do Hawaii, produzido e lançado em 1997.
            </p>
            <br />

            <p>
                O álbum conta com canções como "Nuvem", "A Montanha", "3 Minutos" e "Alucinação" (regravação do sucesso do cantor Belchior).
                Foi o primeiro álbum com a formação "quarteto": Humberto Gessinger (vocal e baixo), Luciano Granja (guitarra), Adal Fonseca
                (bateria e voz) e Lúcio Dorfman (teclados). Granja e Fonseca haviam participado, no ano anterior, no projeto solo do líder do grupo Humberto Gessinger,
                e foram incorporados à banda ao lado de Dorfman.
            </p>
            <br />

            <p>
                O nome Minuano tem três sentidos. O primeiro é o de um vento frio e seco, que sopra a partir do sudoeste, no inverno, após um
                período de mau tempo. O segundo tem referência com Minuanos, uma tribo guerreira extinta, constituída por cavaleiros que percorriam
                o Oeste do Rio Grande do Sul, como nômades. O terceiro, por sua vez, pode significar pampeiro, habitante do pampa.
            </p>
            <br />

            <p>
                A estátua da capa do disco é o Monumento ao Laçador, um monumento de Porto Alegre, que representa o gaúcho tipicamente pilchado
                (em trajes típicos) e teve como modelo o tradicionalista Paixão Cortês. Em 2001, o monumento foi tombado como patrimônio histórico.
                Em 2007, foi transferida da Praça do Bombeador, seu local original, para o Sítio do Laçador.
            </p>
            <br />
            ...
            <p>Duração do album: 41 min. 36 seg.</p>
            <p>Gravadora(s): BMG.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/3dTuUppdZeF5zepfMQuFu1" width="100%" height="700" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br /><br />
