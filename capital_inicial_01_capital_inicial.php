...
<body>
    <main>
        <section class="content-section">
            ...
            <br /><br />
            <p>Duração do álbum: 36 min. 27 seg.</p>
            ...
            <div id="divFL01" name="nm_divFL01">
                <p>
            ...
            <div id="divFEL01" name="nm_divFEL01">
                <p>
            ...
            <div id="divBB01" name="nm_divBB01">
                <p>
