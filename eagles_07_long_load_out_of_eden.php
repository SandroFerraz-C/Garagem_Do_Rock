...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Long Road Out of Eden (2007)</h1>
            <br />

            <p>
                Long Road Out of Eden é o sétimo álbum de estúdio da banda de rock americana Eagles, lançado em 2007 pela Lost Highway Records como um
                álbum duplo.
            </p>
            <br />

            <p>
                Quase seis anos em produção, é o primeiro álbum de estúdio da banda desde 1979, "The Long Run". Nesse meio tempo, a banda gravou
                quatro faixas de estúdio originais para o álbum ao vivo Hell Freezes Over (1994), " Hole in the World " para The Very Best Of (2003)
                e Joe Walsh -penned "One Day at a Time" para a Farewell 1 Tour: Live from Melbourne DVD (2005), que Walsh mais tarde regravou para
                seu álbum Analog Man de 2012.
            </p>
            <br />

            <p>
                O álbum produziu dois singles nas paradas Hot Country Songs: um cover de "How Long" de JD Souther e "Busy Being Fabulous", ambos os
                quais foram os 30 maiores sucessos nas paradas country, bem como os 20 maiores sucessos no Hot Gráficos de faixas contemporâneas
                adultas. O álbum produziu cinco sucessos consecutivos nas paradas Hot Adult Contemporary Tracks com "How Long", "Busy Being Fabulous",
                "No More Cloudy Days", "What Do I Do With My Heart" e "I Don't Want to Ouça mais".
            </p>
            <br />

            <p>
                O álbum estreou em 1° lugar nos Estados Unidos após uma mudança de última hora nas regras da Billboard (que também bloqueou o tão
                antecipado Blackout de Britney Spears de liderar as paradas) e ganhou dois prêmios Grammy por "How Long" e o instrumental "I Dreamed There Was No War".
                O álbum se tornou o sexto álbum nº 1 da banda e foi o álbum mais vendido do ano. Desde então, vendeu 3,5 milhões de cópias apenas nos EUA.
                Sendo um álbum duplo com duração superior a 90 minutos, o álbum foi certificado 7x Platinum pela Recording Industry Association of America
                para embarques de 7 milhões de discos.
            </p>
            <br />

            <p>
                Em uma entrevista de 2007 à CNN, o membro da banda Don Henley declarou: "Este é provavelmente o último álbum dos Eagles que faremos."
                Quando questionado sobre a possibilidade de um álbum seguinte em novembro de 2010, o membro da banda Timothy B. Schmit disse:
                "Minha primeira reação seria: de jeito nenhum. Mas eu disse isso antes do último, então você nunca sabe realmente . As bandas são uma
                entidade frágil e você nunca sabe o que vai acontecer. Demorou muito para fazer esse último álbum, ao longo de alguns anos, na verdade, e
            ...
            <p>
                ...
                <div class="tabela">
                    <table border="1px" width="45%">
                        ...
                        <tr>
                            <td width="15%"> Ouro + Platina </td>
                            <td> + 70.000 (Holanda)</td>
                        </tr>
                        <tr>
                            <td width="15%">3X Platina </td>
                            <td> + 45.000 (Nova Zelândia )</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="15%"> Platina </td>
                            <td> + 30.000 (Dinamarca)</td>
                        </tr>
                        <tr>
                            <td width="15%">Ouro </td>
                            <td> + 20.000 (Áustria)</td>
                        </tr>
                        <tr>
                            <td width="15%"> Platina </td>
                        ...
                        <tr>
                            <td width="15%"> Ouroa </td>
                            <td> + 15.000 (Bélgica)</td>
                        </tr>
                        <tr>
                            <td width="15%"> Ouro </td>
                            <td> + 15.000 (Finlândia)</td>
                        </tr>
                        <tr>
                            <td width="15%"> Platina </td>
            ...
            <p>Duração do album: 90 min. 46 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/6SAnHJMpAAn7fDtexQuGzX" width="100%" height="1150" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe> <br /><br />
                    ...
                    <div id="divJW07" name="nm_divJW07">
                        <p>
                            <img class="css" src="img/eagles/jw.png" width="150px;" height="130px;">
                    ...
                    <div id="divTBS07" name="nm_divTBS07">
                        <p>
                            <img class="css" src="img/eagles/tbs.jpg" width="150px;" height="130px;">
