...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>- Supermercados da Vida é o oitavo álbum da banda Barão Vermelho, lançado em 1992 pela WEA.</p>

            <p>O disco marca a estréia do baixista Rodrigo Santos no lugar de Dadi. Rodrigo estava desempregado em decorrência da dissolução da banda
                de Lobão, que havia optado por carreira solo. Então Guto entrou em contato com Rodrigo Santos e oficializou a vinda do novo baixista.</p>

            <p>Para produzir a capa do álbum foi chamado o artista plástico Antonio Peticov, entretanto seu trabalho não agradou o grupo que acabou
                por escolher uma foto em que pessoas saqueavam um mercado, no último ano do mandato de Fernando Collor de Melo.</p>
            <br /><br />

            <p>Duração do álbum: 44 min. 19 seg.</p>
            ...
            <section>
                <div id="divROBERTO_FREJAT" name="nm_divROBERTO_FREJAT">
                    <p><img class="css" src="img/barao vermelho/rf.jpg" width="150px;" height="130px;">
                        ...
                        amigo, além de compor com/para outros artistas do cenário musical brasileiro.</p>
                </div>
                ...
                <div id="divFERNANDO_MAGALHAES" name="nm_divFERNANDO_MAGALHAES">
                    <p><img class="css" src="img/barao vermelho/fm.jpg" width="150px;" height="130px;">
                        ...
                        como músico contratado), baixo ocasional (desde 2017) </p>
                </div>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="#" onMouseOver="mostraLayer('divMAURICIO_BARROS');" onMouseOut="escondeLayer('divMAURICIO_BARROS');"> Maurício Barros </a> – Teclado.</li>
                </ul>
            </nav>
