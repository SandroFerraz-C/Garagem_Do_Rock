...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Piece of Mind (1983)</h1>
            <br />

            <p>
                - Piece of Mind é o quarto álbum do Iron Maiden, lançado em 16 de maio de 1983.
            </p>
            <br />

            <p>
                O álbum mantém o estilo pesado de - The Number of the Beast mas com um pouco mais de técnica, e suas letras começam a definir
                melhor o perfil de músicas mais trabalhadas e com mais conceito, falando de guerras e temas de filmes e livros (o que já
                acontecia desde os primeiros álbuns, mas em escala menos significativa). Dois singles foram lançados, "Flight of Icarus",
                como uma tentativa de alcançar o mercado norte-americano, e "The Trooper", que acabou se tornando uma das canções mais conhecidas
                da banda.
            </p>
            <br />

            <p>
                O disco é conhecido por ter uma "mensagem secreta" colocada entre as faixas "The Trooper" e "Still Life". Trata-se apenas do
                baterista Nicko McBrain imitando o ditador de Uganda Idi Amin e foi colocada lá para "sacanear" as pessoas que acusavam a banda de
                satanista desde o álbum anterior, - The Number of the Beast.
            </p>
            <br />

            <p>
                O álbum chegou ao terceiro lugar da parada inglesa, e foi o primeiro a alcançar o top 100 da Billboard 200 (chegando à #70ª posição).
                Em 1998 foi relançado com um CD bônus.
            </p>
            <br /><br />
            ...
            <div class="tabela">
                <table border="1px" width="45%">
                    ...
                    <tr>
                        <td width="15%"> 2X Ouro e Platina </td>
            ...
            <p>Duração do album: 46 min. 03 seg.</p>
            <p>Gravadora(s): EMI (Reino Unido) e Harvest/Capitol (EUA).</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/1AEaCLeLtzVCTzOZqSltIs" width="100%" height="550" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br /><br />

                    <ul>
                        <li><a href="#" onMouseOver="mostraLayer('divBD04');" onMouseOut="escondeLayer('divBD04');"> Bruce Dickinson </a> – Vocal. </li>
                        <li><a href="#" onMouseOver="mostraLayer('divSH04');" onMouseOut="escondeLayer('divSH04');"> Steve Harris </a> – Baixo. </li>
                        <li><a href="#" onMouseOver="mostraLayer('divDM04');" onMouseOut="escondeLayer('divDM04');"> Dave Murray </a> – Guitarra. </li>
                        <li><a href="#" onMouseOver="mostraLayer('divCB04');" onMouseOut="escondeLayer('divCB04');"> Clive Burr </a> – Bateria. </li>
                        <li><a href="#" onMouseOver="mostraLayer('divAS04');" onMouseOut="escondeLayer('divAS04');"> Adrian Smith </a> – Guitarra. </li>
                    </ul>

                    <div id="divBD04" name="nm_divBD04">
                        <p>
                    ...
                    <div id="divSH04" name="nm_divSH04">
                        <p>
                    ...
                    <div id="divCB04" name="nm_divCB04">
                        <p>
                    ...
                    <div id="divAS04" name="nm_divAS04">
                        <p>
