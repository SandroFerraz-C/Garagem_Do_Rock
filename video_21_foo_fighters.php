...
<body>
    ...
    <div class="letra">
        ...
        <p>
            ...
            <br />
            Toda vez que eu tenho uma recaída
        </p>
        <br />
        ...
        <p>
            ...
            <br />
            Quando fazíamos montinhos de papéis
            <br />
            E sentávamos e assistíamos elas queimarem?
            <br />
            Acho que encontrei o meu lugar
            <br />
            Você não vê esse sentimento crescendo?
            <br />
            De ganhar pequenas conquistas?
        </p>
        <br />
        ...
        <p>
            Você vive a vida um momento de cada vez
            <br />
            Mas lá dentro, sussurra uma revolta
            <br />
            De um sacrifício, mas sabendo sobreviver
            <br />
            O primeiro declínio, um outro estado de espírito
            <br />
            Estou de joelhos, pedindo um sinal
            <br />
            Para sempre, quando for
            <br />
