...
<body>
    <main>
        <section class="content-section">
            ...
            <h1>Rosas e Vinho Tinto (2002)</h1>

            <p>
                Rosas e Vinho Tinto é o nono álbum do Capital Inicial.
            </p>

            <p>
                Lançado no ano de 2002, o álbum obteve grande sucesso comercial com o lançamento de cinco singles:
                "À Sua Maneira" (outra versão em português da canção "De Música Ligera", da banda argentina Soda Stereo),
                "Quatro Vezes Você" (ambas em 2002), "Mais", "Como Devia Estar" e "Olhos Vermelhos" (ambas em 2003), sendo
                que a última foi trilha sonora do filme Dom.
            </p>

            <p>
                Foi o primeiro álbum sem o guitarrista original Loro Jones, substituído por Yves Passarell da extinta banda
                Viper e irmão de Pit Passarell, autor de um sucesso do Capital, "O Mundo". Yves chegou a ir na praia com a banda
                para ajudar na composição das novas canções. Além de Alvin L, parceiros de composição incluem Pit, Kiko
                Zambianchi (que a banda conheceu durante o bem-sucedido Acústico MTV) e Mingau, do Ultraje a Rigor.
            </p>
            <br />

            <p>Duração do album: 57 min. 38 seg.</p>
            <p>Gravadora(s): Abril Music.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/6P9Ig7QZYdWctTFYg2AykD" width="100%" height="900" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br />
                    ...
                    <nav>
                        ...
                        <ul>
                            <li><a href="#" onMouseOver="mostraLayer('divDOP09');" onMouseOut="escondeLayer('divDOP09');">Dinho Ouro Preto</a> – Voz.</li>
                            <li><a href="#" onMouseOver="mostraLayer('divYP09');" onMouseOut="escondeLayer('divYP09');">Yves Passarell</a> – Guitarra e Violão.</li>
                            <li><a href="#" onMouseOver="mostraLayer('divFL09');" onMouseOut="escondeLayer('divFL09');">Flávio Lemos</a> – Baixo.</li>
                            <li><a href="#" onMouseOver="mostraLayer('divFEL09');" onMouseOut="escondeLayer('divFEL09');">Fê Lemos</a> – Bateria.</li>
                            <li><a href="#">Aislan Gomes</a> – Teclados e Pianos (Como Convidado).</li>
                        </ul>
                    </nav>
                    <br />

                    <div id="divDOP09" name="nm_divDOP09">
                        <p>
                    ...
                    <div id="divYP09" name="nm_divYP09">
                        <p>
                    ...
                    <div id="divFEL09" name="nm_divFEL09">
                        <p>
