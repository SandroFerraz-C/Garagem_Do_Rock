    ...
    <main>
        <section class="content-section">
            ...
            <p>
                ...
                verdade vocais-guia, porque Iommi achou que soavam melhor do que as gravações posteriores.
            </p>
            <br /><br />

            <p>Duração do album: 42 min. 57 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <div id="divLC14" name="nm_divLC14">
                        <p>
                            <img class="css" src="img/Black Sabbath/lc.jpg" width="150px;" height="130px;">
                    ...
                    <div id="divBM14" name="nm_divBM14">
                        <p>
                            <img class="css" src="img/Black Sabbath/bm.jpg" width="150px;" height="130px;">
