...
<body>
    <main>
        <section class="content-section">
            ...
            <p>Duração do álbum: 46 min. 07 seg.</p>
            <p>Gravadora(s): BMG.</p>
            ...
            <div id="divDOP12" name="nm_divDOP12">
                <p>
            ...
            <div id="divYP12" name="nm_divYP12">
                <p>
            ...
            <div id="divFL12" name="nm_divFL12">
                <p>
            ...
            <div id="divFEL12" name="nm_divFEL12">
                <p>
