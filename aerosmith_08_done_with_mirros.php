...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>- Done with Mirrors é o oitavo álbum do Aerosmith, lançado em Novembro de 1985.</p>

            <p>Em 1985 a banda retorna com sua formação original para a gravação do Done With Mirros, considerado por muitos como um álbum dispensável.
            ...
            <p>Em 1985 estavam todos muito ansiosos para o retorno da formação original da banda. O Aerosmith trocou de gravadora, saindo da
                Columbia e assinando um contrato com a Geffen.
            </p>

            <p> Abandonaram a produção de Jack Douglas e contrataram para produzir o álbum Ted
                Templamen, que era o responsável pelo estrondoso sucesso do Van Halen no final dos anos 70 até meados dos anos 80.</p>

            <p>De acordo com o título, todo o texto (exceto o número de catálogo e UPC) nas versões originais foi escrito de trás para frente
                - para ser lido segurando-o contra um espelho. O relançamento vira a arte para que possa ser lida sem espelho e adiciona o logotipo
                da banda. Como resultado, o CD original (que veio em uma caixa longa) pode ser colecionado. (Todo o texto no livreto da primeira prensagem
                de CD também é invertido.)
                <br /><br />
                O título refere-se tanto a ilusões que se “acabam com espelhos”, quanto ao despejo de drogas como a cocaína, tradicionalmente
                cheirada em um espelho.
            </p>
            <br />
            ...
            <p>Duração do álbum: 33 min. 44 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    <iframe src="https://open.spotify.com/embed/playlist/236eoQhGOr7pnTJUocgsug" width="100%" height="550" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                </table>
            </section>
