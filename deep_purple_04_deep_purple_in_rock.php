...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Deep Purple in Rock (1970)</h1>

            <p>Deep Purple in Rock, é o quarto álbum de estúdio lançado pela banda Deep Purple.</p>

            <p>O disco marcou a estreia da formação mais bem sucedida da banda com Ian Gillan e Roger Glover, substitutos de Rod Evans e Nick Simper.</p>

            <p>A capa de Deep Purple in Rock foi inspirada pelo Monte Rushmore, uma escultura feita perto de Keystone, Dakota do Sul, nos
                Estados Unidos. A escultura foi feita por Gotzon Borglum e seu filho Lincoln Borglum e incluía esculturas das cabeças de
                George Washington, Thomas Jefferson, Theodore Roosevelt e Abraham Lincoln, que eram quatro presidentes dos Estados Unidos.
                Na capa do álbum Ian Gillan fica no lugar de George Washington, Ritchie Blackmore no lugar de Thomas Jefferson, Jon Lord no
                lugar de Theodore Roosevelt, Roger Glover no lugar de Abraham Lincoln e apenas Ian Paice não fica no lugar de nenhum
                presidente da escultura.</p>
            <br /><br />
            ...
            <p>Duração do álbum: 41 min. 46 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    <iframe src="https://open.spotify.com/embed/playlist/67B7OCFEPkrqKzfnaE2cwc" width="100%" height="500" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                </table>
            </section>
            ...
            <nav>
                <h3>Créditos</h3>
                <ul>
                    <li><a href="#" onMouseOver="mostraLayer('divIG04');" onMouseOut="escondeLayer('divIG04');">Ian Gillan</a> – Vocal. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divRB04');" onMouseOut="escondeLayer('divRB04');">Ritchie Blackmore</a> – Guitarra. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divRG04');" onMouseOut="escondeLayer('divRG04');">Roger Glover</a> – Baixo e Vocal de Apoio. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divJL04');" onMouseOut="escondeLayer('divJL04');">Jon Lord</a> – Órgão, Teclados e Vocal de apoio. </li>
                    <li><a href="#" onMouseOver="mostraLayer('divIP04');" onMouseOut="escondeLayer('divIP04');">Ian Paice</a> – Bateria. </li>
                </ul>
            </nav>

            <div id="divIG04" name="nm_divIG04">
            ...
            <div id="divRG04" name="nm_divRG04">
            ...
            <div id="divJL04" name="nm_divJL04">
