...
<body>
    ...
    <iframe width="560" height="445" src="https://www.youtube.com/embed/r00ikilDxW4" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <div class="letra_video_22_green_day">

        <h1>21 Guns</h1>
        <br />

        <h2>Salva de Tiros</h2>
        <br /> <br />
        ...
        <p>
            ...
            <br />
            Como um mentiroso pedindo perdão a uma pedra
        </p>
        <br />
