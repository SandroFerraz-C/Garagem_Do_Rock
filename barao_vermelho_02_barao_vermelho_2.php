...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Barão Vermelho 2 (1983)</h1>
            <br />

            <p>
                Barão Vermelho 2 é o segundo álbum de estudio da banda Barão Vermelho, lançado em 1983.
            </p>
            <br />
            ...
            <p>Duração do album: 32 min. 40 seg.</p>
            <p>Gravadora(s): Opus Columbia - (Joint-Venture de Som Livre e Discos CBS).</p>
            <p>Produção: Ezequiel Neves e Andy P. Mills. </p>
            <br /><br />
            ...
            <section class="disco">
                ...
                <iframe src="https://open.spotify.com/embed/playlist/3LQCcxRDcdaOCpnrTZv38Z" width="98%" height="640" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                        <br /><br />
                    <ul>
