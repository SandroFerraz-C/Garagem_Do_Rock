...
<body>
    <main>
        <section class="content-section">
            ...
            <h1>Burning Bridges (2015)</h1>

            <p>
                - Burning Bridges é o décimo terceiro álbum da banda Bon Jovi. Foi lançado mundialmente em 21 de agosto de 2015 pela Mercury Records.
            </p>

            <p>
                É o 1° álbum sem o guitarrista Richie Sambora, que deixou a banda em 2013 (mas é apontado como co-autor do single "Saturday Night Gave Me Sunday Morning").
                <br />
                Burning - Bridges é o último álbum da banda com a Mercury, finalizando os 32 anos de história entre eles.
            </p>

            <p>
                - Burning Bridges foi concebido para finalizar os compromissos da banda com a Mercury Records, pois ambas as partes não conseguiam
                concordar em certos termos do contrato de gravação da banda. "Eu fiquei nessa gravadora minha vida inteira - 32 anos. Sou o artistas
                com o maior tempo de casa na Mercury [...]. Mas meu acordo estava finalizado, e é isso".
            </p>


            <p>
                A faixa título do álbum expressa a insatisfação da banda com a gravadora. Segundo Jon, "Essa bate na cabeça e te diz o que aconteceu.
                Escute as letras porque elas explicam exatamente o que aconteceu. E é isso." Sobre a separação, um representante da Mercury Records
                afirmou que "Jon é um ícone do rock 'n' roll, e nós estamos muito orgulhosos de sua colaboração de 30 anos com a Mercury, que nos
                trouxe um extraordinário sucesso comercial e criativo. Nós desejamos apenas o melhor a Jon."
            </p>
            <br />

            <p>Duração do álbum: 40 min. 22 seg.</p>
            ...
            <section>
                ...
                <div id="divJOHN_SHANKS" name="nm_divJOHN_SHANKS">
                    <p>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="#" onMouseOver="mostraLayer('divJOHN_SHANKS');" onMouseOut="escondeLayer('divJOHN_SHANKS');">John Shanks</a> – Guitarras.</li>
