...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <h1>Independência (1987)</h1>
            <br />

            <p>
                Independência é o segundo álbum do Capital Inicial. Foi lançado em 1987.
            </p>
            <br />

            <p>
                O álbum marcou a entrada na banda do tecladista Bozo Barretti, que havia produzido o álbum de estreia. Ao contrário do
                predecessor, que foi composto ao longo de três anos, as canções de Independência foram todas escritas em apenas um mês, à
                exceção de "Descendo o Rio Nilo", faixa-título do EP de estreia da banda, de "Fantasmas" e de "Prova".
            </p>

            <p>A capa do disco foi feita por Ico Ouro Preto, irmão do vocalista Dinho Ouro Preto. Segundo o Jornal do Brasil, o álbum
                vendeu mais de 170 mil cópias. </p>
            <br /><br />

            <p>Duração do album: 38 min. 36 seg.</p>
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <iframe src="https://open.spotify.com/embed/playlist/2pyI9Ja5SVjBeEgPntCjBo" width="98%" height="600" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    <br /><br />
                    ...
                    <div id="divFL02" name="nm_divFL02">
                        <p>
                    ...
                    <div id="divFEL02" name="nm_divFEL02">
                        <p>
                    ...
                    <div id="divBB02" name="nm_divBB02">
                        <p>
