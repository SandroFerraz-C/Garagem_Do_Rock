...
<body>
    ...
    <main>
        <section class="content-section">
            ...
            <p>
                Após ouvir uma Fita Demo da banda gravada em 1981, o produtor Ezequiel Neves convence o diretor artístico da Som Livre a gravar a banda.
                Juntos convencem o presidente da Som Livre, João Araújo (pai de Cazuza) a lançar a banda. A banda entra em estúdio para gravar seu primeiro
                álbum. Barão Vermelho, gravado em dois dias, é lançado em 15 de setembro de 1982. Contudo, o disco não alcança altas vendas. A música
                "Todo Amor Que Houver Nessa Vida" tornou-se um dos clássicos da banda e Caetano Veloso a inclui no seu repertório em 1983. Também
                destacam-se "Down em Mim" e "Ponto Fraco".
            </p>
            <br />

            <p>Duração do album: 31 min. 09 seg.</p>
            <p>Gravadora(s): Opus Columbia - (Joint-Venture de Som Livre e Discos CBS).</p>
            <p>Produção: Ezequiel Neves e Guto Graça Mello. </p>
            <br /><br />
            ...
            <section class="disco">
                <table id="demo-table">
                    ...
                    <div id="divCZZ01" name="nm_divCZZ01">
                        <p>
                    ...
                    <div id="divRF01" name="nm_divRF01">
                        <p>
                    ...
                    <div id="divDE01" name="nm_divDE01">
                        <p>
                    ...
                    <div id="divGG01" name="nm_divGG01">
                        <p>
